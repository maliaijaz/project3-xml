...
public class Movie {
	...
	public Movie(int id, String title, int release, String guy_who_made_the_film, String poster_url, String trailer_url, ArrayList<Genre>Genres, ArrayList<Star>Stars){
		movie_id=id;
		movie_title=title;
		year=release;
		director=guy_who_made_the_film;
	...
	public String processUrl(String url){   //processUrl can also act as setUrl but the fields must first be accessed by their get functions
